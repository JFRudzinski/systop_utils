...
for i_mol, moltype in enumerate(system.molnames):
    print('\n')
    print('MOLTYPE = '+moltype+':'+'\t'+str(system.children[i_mol]))
    ...
    if system.moltypes[moltype].n_res == 1:
        ...
        print('\t ATOMS:')
        for atom in system.children[i_mol].children:
            print('\t'+str(atom))
    else:
        ...
        for i_res, res in enumerate(system.moltypes[moltype].resnames):
            print('\t RESTYPE = '+res+':'+'\t'+str(system.children[i_mol].children[i_res]))
            ...
            print('\t\t ATOMS:')
            for atom in system.children[i_mol].children[i_res].children:
                print('\t\t'+str(atom))
